...
INBUILT_FUNCTION_META = {
    ...
    'remove_kay': {'min_args': 2, 'max_args': 2, 'snippet': 'remove_kay()', 'description': 'remove_key(dict, key) - removes a dictionary entry and returns the updated dictionary'},
