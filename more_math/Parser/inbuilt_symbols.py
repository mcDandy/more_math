...
INBUILT_FUNCTION_META = {
    ...
    'argmax': {'min_args': 1, 'max_args': 1, 'snippet': 'argmax()', 'description': 'argmax(x) - returns the index of the maximum value in flattened x'},
    'argmin': {'min_args': 1, 'max_args': 1, 'snippet': 'argmin()', 'description': 'argmin(x) - returns the index of the minimum value in flattened x'},
    'argsort': {'min_args': 1, 'max_args': 2, 'snippet': 'argsort()', 'description': 'argsort(x, [desc]) - returns the indices that would sort x. defaults to ascending. Uses last dimension to sort'},
    ...
    'cumsum': {'min_args': 1, 'max_args': 1, 'snippet': 'cumsum()', 'description': 'cumsum(x) - computes the cumulative sum over first dimension.'},
    ...
    'sum': {'min_args': 1, 'max_args': 1, 'snippet': 'sum()', 'description': 'sum(x) - computes the sum of elements of x'},
    'svd': {'min_args': 1, 'max_args': 1, 'snippet': 'svd()', 'description': 'svd(x) - computes the singular value decomposition of x. Returns a list of 3 tensors: U, S, V such that x = matmul(matmul(U, diagonal_matrix(S,shape(U))), V)'},
