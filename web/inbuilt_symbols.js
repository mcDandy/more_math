...
export const FUNCTION_META = {
    ...
    svd: { minArgs: 1, maxArgs: 1, snippet: "svd()", description: "svd(x) - computes the singular value decomposition of x. Returns a list of 3 tensors: U, S, V such that x = matmul(matmul(U, diagonal_matrix(S,shape(U))), V)" },
