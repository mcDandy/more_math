...
export const FUNCTION_META = {
    ...
    singular_value_decomposition: { minArgs: 1, maxArgs: 1, snippet: "singular_value_decomposition()", description: "svd(x) - computes the singular value decomposition of x. Returns a list of 3 tensors: U, S, V such that x = matmul(matmul(U, diagonal_matrix(S,shape(U))), V)" },
